...
namespace Fulo.Lang.Tokens
{
    public enum TokenType
    {
        ...
        AND, CLASS, ELSE, FALSE, FUN, FOR, IF, NIL, OR, PRINT, RETURN, SUPER, THIS, TRUE, LET, WHILE, LOOP, BREAK, INTERNAL,
        DEPRECATED, LOAD, STRICT, IS, AS, MATCH, CASE, CHANGELANG, NAMESET, SWITCH, DEFAULT,
